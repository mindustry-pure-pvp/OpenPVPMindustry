    ...
    public boolean tap(float x, float y, int count, KeyCode button){
        ...
        if(hasPlan(cursor) && !commandMode){
            ...
            if(count == 2){
                ...
                if(unitTapped != null && state.rules.possessionAllowed && unitTapped.isAI() && unitTapped.team == player.team() && !unitTapped.dead && !unitTapped.inPayload && unitTapped.playerControllable()){
